#############################################################################
# Makefile for building: QtSim.app/Contents/MacOS/QtSim
# Generated by qmake (3.1) (Qt 6.9.1)
# Project:  QtSim.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile QtSim.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = QtSim1.0.0
DISTDIR = /Users/jamesmeegan/Desktop/softwareDev/after_layoff/c++/Missle\ Defense\ System/.tmp/QtSim1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		QtSim.pro simulator.h main.cpp \
		simulator.cpp
QMAKE_TARGET  = QtSim
DESTDIR       = 
TARGET        = QtSim.app/Contents/MacOS/QtSim
...
EXPORT__PRO_FILE_ = /Users/jamesmeegan/Desktop/softwareDev/after_layoff/c++/Missle Defense System/QtSim.pro
...
QtSim.app/Contents/MacOS/QtSim:  $(OBJECTS)  
	@test -d QtSim.app/Contents/MacOS/ || mkdir -p QtSim.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: QtSim.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/macx.conf \
...
QtSim.app/Contents/PkgInfo: 
	@test -d QtSim.app/Contents || mkdir -p QtSim.app/Contents
	@$(DEL_FILE) QtSim.app/Contents/PkgInfo
	@echo "APPL????" > QtSim.app/Contents/PkgInfo
QtSim.app/Contents/Info.plist: 
	@test -d QtSim.app/Contents || mkdir -p QtSim.app/Contents
	@$(DEL_FILE) QtSim.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.QtSim,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.QtSim,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,QtSim,g" -e "s,@LIBRARY@,QtSim,g" -e "s,\$${EXECUTABLE_NAME},QtSim,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >QtSim.app/Contents/Info.plist

all: Makefile \
		QtSim.app/Contents/PkgInfo \
		QtSim.app/Contents/Info.plist QtSim.app/Contents/MacOS/QtSim
...
distdir: FORCE
	...
	$(COPY_FILE) --parents simulator.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp simulator.cpp $(DISTDIR)/
